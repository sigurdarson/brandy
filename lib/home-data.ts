...
/** Single source of truth for marketing copy and site settings. */
export const HOME_PAGE_DATA: HomePagePayload = {
  seo: {
  ...
  hero: {
    headline: "European product studio building websites, digital products, and design systems for companies who want to move faster without losing craft.",
    primaryCtaLabel: "Start a project",
    secondaryCtaLabel: "Let's talk",
    secondaryCtaUrl: "https://t.me/sigurdarson",
  },
  services: {
    intro:
  ...
  siteSettings: {
    ...
    footerSignoff: "Designed and built by humans, with help from AI.",
  },
};
